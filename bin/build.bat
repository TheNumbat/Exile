...
set Game_DebugCompilerFlags=-Od -MTd -nologo -Gr -EHa -Oi -W4 -Z7 -FC -Fegame.dll -LD
set Game_ReleaseCompilerFlags=-O2 -MTd -nologo -Gr -EHa -W4 -FC -Fegame.dll -LD
set Game_LinkerFlags=/NODEFAULTLIB:MSVCRT /SUBSYSTEM:console opengl32.lib -PDB:game_%random%.pdb

set Platform_DebugCompilerFlags=-Od -MTd -nologo -Gr -EHa -Oi -W4 -Z7 -FC -Femain.exe
