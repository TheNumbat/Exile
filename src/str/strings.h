...
// TODO(max): should remove all templates, they're not strictly necessary
...
template<typename T> u32 print_enum(string s, u32 idx, T& val, _type_info* info, bool size = false);
...
template<typename T> i64 int_as_i64(T& val, _type_info* info);
