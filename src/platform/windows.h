...
DLL_IMPORT const GLubyte* APIENTRY glGetString(GLenum name);

DLL_IMPORT void APIENTRY glDeleteTextures (GLsizei n, const GLuint *textures);
DLL_IMPORT void APIENTRY glTexParameteri (GLenum target, GLenum pname, GLint param);
DLL_IMPORT void APIENTRY glTexParameterfv (GLenum target, GLenum pname, const GLfloat *params);
DLL_IMPORT void APIENTRY glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);

DLL_IMPORT void APIENTRY glBlendFunc (GLenum sfactor, GLenum dfactor);

DLL_IMPORT void APIENTRY glEnable (GLenum cap);
DLL_IMPORT void APIENTRY glDisable (GLenum cap);

DLL_IMPORT void APIENTRY glClear (GLbitfield mask);
DLL_IMPORT void APIENTRY glClearColor (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
DLL_IMPORT void APIENTRY glViewport (GLint x, GLint y, GLsizei width, GLsizei height);

DLL_IMPORT void APIENTRY glDrawArrays (GLenum mode, GLint first, GLsizei count);
