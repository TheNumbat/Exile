...
CALLBACK void run_mesh_2d_col(render_command* cmd) { PROF
	...
	glDrawElements(gl_draw_mode::triangles, cmd->num_tris ? cmd->num_tris * 3 : cmd->m2dc->elements.size * 3, gl_index_type::unsigned_int, (void*)(u64)(cmd->start_tri * 3));
}

CALLBACK void run_mesh_2d_tex(render_command* cmd) { PROF

	glDisable(gl_capability::depth_test);
	glDrawElements(gl_draw_mode::triangles, cmd->num_tris ? cmd->num_tris * 3 : cmd->m2dt->elements.size * 3, gl_index_type::unsigned_int, (void*)(u64)(cmd->start_tri * 3));
}

CALLBACK void run_mesh_2d_tex_col(render_command* cmd) { PROF

	glDisable(gl_capability::depth_test);
	glDrawElements(gl_draw_mode::triangles, cmd->num_tris ? cmd->num_tris * 3 : cmd->m2dtc->elements.size * 3, gl_index_type::unsigned_int, (void*)(u64)(cmd->start_tri * 3));
}

CALLBACK void run_mesh_3d_tex(render_command* cmd) { PROF

	glEnable(gl_capability::depth_test);
	glDrawElements(gl_draw_mode::triangles, cmd->num_tris ? cmd->num_tris * 3 : cmd->m3dt->elements.size * 3, gl_index_type::unsigned_int, (void*)(u64)(cmd->start_tri * 3));
}
